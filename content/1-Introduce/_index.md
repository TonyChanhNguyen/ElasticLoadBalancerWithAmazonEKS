...
**Two type services below are not in scope of this workshop.**
...
**In this workshop, we will only focus on how to integrate persistent storage on EKS Cluster with Amazon EBS and Amazon EFS by Static Provisioning and Dynamic Provisioning.**
